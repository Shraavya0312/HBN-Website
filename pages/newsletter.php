...
<head>
    ...
    <title>HBN Website-Newsletter</title>
...
<body class="mainbody">
    ...
    <main>
        ...
        <div style="padding-left: 40px; padding-right: 40px;">
            ...
            <h2 class="subheading"> <a href="../index.html"><img src="../assets/back.png" height="40px" width="40px" style="opacity: 0.8; margin-top: -10px;"/></a> SUBSCRIBE TO OUR NEWSLETTER</h2>
            <br>
            <center>
            <form method="post" action="newsletter.php">
                ...
                <br>
                <br>
                <textarea class="textar3" name="address" placeholder="Your Address" required></textarea>
                <br>
                <br>
                <input type="submit" name="submit" value="Subscribe!" class="joinbutton" style="padding-top: 10px; padding-bottom: 10px; padding-right: 50px; padding-left: 50px; font-size: 18px;"/>
            </form>
            </center>
        </div>
    </main>
    ...
    <footer class="mainfooter">
        <div class="footer">
          ...
          <div>
            ...
            <br>
            <h5><a class="footerlist" href="#">Subscribe to our Newsletter</a></h5>
            <br>
          </div>
...
<?php
    ...
    if(isset($_POST['submit'])){
      ...
      $sql = "insert into newsletter(name,email,number,address) values('$name','$email','$number','$address')";
